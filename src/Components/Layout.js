     ...
     classes={{paper: classes.drawerPaper}}>
       <h2>FSM</h2>
        ...
        <Link className={classes.link} to={'/'}> 
            <div className="menuItem dashboard" id={"dashboard"} onClick={(e)=>menuItemSelected(e.target.id)}>
            ...
            <div className="menuItem" id={"notifications"} onClick={(e)=>menuItemSelected(e.target.id)}>
            ...
            <div className="menuItem" id={"user-profile"} onClick={(e)=>menuItemSelected(e.target.id)}>
            ...
            <div className="menuItem" id={"analytics"} onClick={(e)=>menuItemSelected(e.target.id)}>
         ...
         <div className="subRight">
             ...
             <Switch>
             <Route exact path='/' component={Workstations}/>
