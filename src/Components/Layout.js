...
import {Dashboard, Timeline, DateRange} from '@material-ui/icons'
     ...
     classes={{paper: classes.drawerPaper}}>
       <h2>Admin</h2>
        ...
        <Link className={classes.link} to={'/'}> 
            <div className="menuItem dashboard" id={d}>
            ...
            <div className="menuItem" id={cal}>
            <div className="menuLeft"> <DateRange/> </div>
            <div className="menuRight"> 
            User Profile
             </div>
            </div>
