...
export const Ws3PB = () => {
  ...
  useEffect(()=>{
      db.collection("OrderTest").doc("CurrentOrder").onSnapshot(doc=>{
        ...
        if(doc.data().Process!="Machine 2 Started" && doc.data().Process!="Machine 2 Stopped" && doc.data().Process!="Machine 3 Started" && doc.data().Process!="Machine 3 Stopped" && doc.data().Process!="" )
